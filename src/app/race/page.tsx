...
export default async function RacePage() {
  ...
  return (
    <main className="flex min-h-dvh flex-col">
      ...
      <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col items-center gap-10 px-6 pb-24 pt-10">
        <header className="flex flex-col items-center gap-3 text-center">
          <h1 className="text-balance text-3xl font-medium tracking-tight sm:text-4xl">Race a friend</h1>
