    ...
    Tables: {
      ...
      races: {
        Row: {
          ...
          status: string;
          host_progress: Json | null;
          guest_progress: Json | null;
          host_solve_id: string | null;
          host_duration_ms: number | null;
          host_penalty: string | null;
          guest_solve_id: string | null;
          guest_duration_ms: number | null;
          guest_penalty: string | null;
          winner: string | null;
